...
void Timer4A_Init(void){ //Sleep
	SYSCTL_RCGCTIMER_R |= 0x10;   //  activate TIMER5
	OSMsCount = 0;
	TIMER4_CTL_R = 0x00000000;    // disable timer5A during setup
  ...
  TIMER4_IMR_R = 0x00000001;    // enable timeout interrupts
	TIMER4_CTL_R |= 0x00000001;   // enable timer5A 32-b, periodic, no interrupts
}
