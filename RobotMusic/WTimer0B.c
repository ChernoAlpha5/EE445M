...
voidFn WideTimer0B_Task(void){
	return WTimer0BPeriodicTask;
}

uint8_t WideTimer0B_Available(void){
	return WTimer0BAvailable;
}

void WideTimer0B_Stop(void){
	WTIMER0_CTL_R = (WTIMER0_CTL_R&~0x00001F00);    // disable Wtimer0B
	WTimer0BAvailable = 1;
}
