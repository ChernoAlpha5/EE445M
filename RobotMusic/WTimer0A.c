...
uint8_t WideTimer0A_Available(void){
	return WTimer0AAvailable;
}

voidFn WideTimer0A_Task(void){
	return WTimer0APeriodicTask;
}

void WideTimer0A_Stop(void){
	WTIMER0_CTL_R = (WTIMER0_CTL_R&~0x0000001F);    // disable Wtimer0A
	WTimer0AAvailable = 1;
}
